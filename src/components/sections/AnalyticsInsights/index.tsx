      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                  ...
                  <div style={{ width: '473px', display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    ...
                    <div style={{
                      ...
                      Post-level drill-downs or portfolio roll-ups across hundreds of models.
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                  ...
                  <div style={{ width: '473px', display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    ...
                    <div style={{
                      ...
                      Best posting windows, hook lines, under-served formats surfaced daily.
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                  ...
                  <div style={{ width: '473px', display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    ...
                    <div style={{
                      ...
                      CSV, PDF or live link; schedule auto-reports for stakeholders.
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                  ...
                  <div style={{ width: '473px', display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    ...
                    <div style={{
                      ...
                      GA4, Meta Pixel, TikTok Pixel & Shopify connectors tie posts to revenue.
                    </div>
                  </div>
                </div>
            ...
            {/* Right Visual - Analytics & Insights Image */}
            <div style={{
              width: '500px',
              height: '400px',
              borderRadius: '20px',
